...
public class ImageAudioHiding extends JFrame implements ActionListener
{
 ...
 public BufferedImage getHostImage()
 {
  ...
  try
  {
   img = ImageIO.read(new File("/Users/manasgaur/Documents/javaworkspace/Crypto/src/ImageHidingCode/host_image.jpg"));
  }
...
*/
 ...
 public ImageAudioHiding()
 {
  ...
  SoundPlayer player = new SoundPlayer("/Users/manasgaur/Downloads/president_speech.wav");
  ...
  host.encode(content, this.getBits()); //this.getSecretImage()
 ...
 {
  ImageAudioHiding frame = new ImageAudioHiding();
...
class Steganography
{
 ...
 // changes made here BufferedImage encodeImage, keed encodeBits 4
 public void encode(String content, int encodeBits)
 {
